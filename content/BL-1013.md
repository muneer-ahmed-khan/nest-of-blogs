...
topic: Python
abstract: "Python OOP done right: dataclasses, properties, and the design patterns that show up most in real codebases, with guidance on when to actually use them."
isPublished: true
---
