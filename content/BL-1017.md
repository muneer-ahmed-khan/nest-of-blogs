...
topic: Next.js
abstract: A complete guide to adding authentication to a Next.js App Router application using NextAuth.js v5 — covering OAuth providers, credentials login, session handling, protected routes, and security best practices.
isPublished: true
---
...
**3. Use HTTPS in production** — NextAuth sets cookies with `Secure` flag automatically in production.
